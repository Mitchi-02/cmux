...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .toggleStickyTerminal: return ShortcutStroke(key: "t", command: true, shift: true)
        ...
        case .reopenClosedBrowserPanel: return ShortcutStroke(key: "z", command: true, shift: true)
